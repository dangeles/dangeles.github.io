...
author: David
description: "t-SNE preserves local distances, not global structure — making it a plotting tool, not a clustering algorithm. A practical guide to what t-SNE actually does and how to use it correctly in bioinformatics."
---
