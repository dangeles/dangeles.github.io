...
categories: ML
author: David
description: "Tuning a neural network from 94% to 98% accuracy — and discovering ChatGPT's first failure mode when it could not fix a simple bug that zero-shot prompt engineering ultimately resolved."
---
