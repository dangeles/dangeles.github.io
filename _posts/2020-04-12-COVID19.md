...
author: David
description: "An epidemiological introduction to SARS-CoV-2 using a SIR model — calculating the viral reproductive number R0 and what it reveals about the trajectory of a pandemic."
---
